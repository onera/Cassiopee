...
C Initialization of scully vortex in field
C     Adimensionnement avec roinfini = 1 et uinfini = 1
C ============================================================================

      SUBROUTINE k6scully(x0, y0, Gamma, a, MInf,
     &                    npts,      
     &                    xc, yc, zc,
     &                    u)
C
...
C     Initialisation
      ...
      pa = pinf*((1-ptmp/(2*a*a))**(1.4D0/0.4D0))
      roa = (pa/pinf)**(1./1.4)*roinf
      T = pa/(roa*287.D0)
