# Taken from cmake 3.12.3, and replaced
# SWIG_COMPILE_DEFINITIONS => INTERFACE_COMPILE_DEFINITIONS
# SWIG_INCLUDE_DIRECTORIES => INTERFACE_INCLUDE_DIRECTORIES
# In order to fix include and compile defs not taking into account those from the dependencies
...
function(SWIG_ADD_SOURCE_TO_MODULE name outfiles infile)
  ...
  set (property "$<TARGET_PROPERTY:${target_name},INTERFACE_INCLUDE_DIRECTORIES>")
  list (APPEND swig_source_file_flags "$<$<BOOL:${property}>:-I$<JOIN:$<TARGET_GENEX_EVAL:${target_name},${property}>,$<SEMICOLON>-I>>")

  set (property "$<TARGET_PROPERTY:${target_name},INTERFACE_COMPILE_DEFINITIONS>")
