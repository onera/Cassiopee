...
# Prepare
t, tc = myApp.prepare('naca1DEuler.cgns', t_out=LOCAL+'/t.cgns', tc_out=LOCAL+'/tc.cgns', NP=0)
...
Internal._rmNodesFromType(t, '.Solver#Param')
Internal._rmNodesFromType(t, '.Solver#ownData')
Internal._rmNodesFromType(t, '.Solver#dtloc')
