...
# Prepare
t, tc = App.prepare1('naca1DEuler.cgns', t_out='t.cgns', tc_out='tc.cgns', frontType=2)
test.testT(tc, 1)
...
# Post
t, zw = myApp.post('naca1DEuler.cgns', 'restart.cgns', 'tc_restart.cgns', t_out='out.cgns', wall_out='wall.cgns')
test.testT(t, 3)
