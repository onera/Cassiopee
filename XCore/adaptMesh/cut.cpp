	...
	for (i = 0; i < nchildren; i++) {
		...
		for (j = 0; j < 6; j++) {
			...
			if (M->owner[face] == -1 && M->neigh[face] == -1) {
				// E_Internal face
				/*prE_Intf("Skipping E_Internal face %d: ", face);
				E_Int *pn = &M->NGON[4*face];
				for (E_Int k = 0; k < 4; k++)
					prE_Intf("%d ", pn[k]);
				puts("");
...
static
void Q6_get_ordered_data(E_Int face, mesh *M, E_Int i0, E_Int reorient, E_Int *children, E_Int *local)
{
	E_Int *pn = &M->NGON[4*face];
...
void cut_cell_xy(E_Int cell, mesh *M, tree *ct, tree *ft)
{
	...
	new_face_0[0] = NODES[8];
	new_face_0[1] = NODES[12];
	new_face_0[2] = NODES[17];
	new_face_0[3] = NODES[13];

	new_face_1[0] = NODES[12];
	new_face_1[1] = NODES[10];
	new_face_1[2] = NODES[15];
	new_face_1[3] = NODES[17];

	new_face_2[0] = NODES[12];
	new_face_2[1] = NODES[11];
	new_face_2[2] = NODES[16];
	new_face_2[3] = NODES[17];

	new_face_3[0] = NODES[9];
	new_face_3[1] = NODES[12];
	new_face_3[2] = NODES[17];
	new_face_3[3] = NODES[14];
...
void cut_cell_xz(E_Int cell, mesh *M, tree *ct, tree *ft)
{
	...
	new_face_0[0] = NODES[8];
	new_face_0[1] = NODES[13];
	new_face_0[2] = NODES[17];
	new_face_0[3] = NODES[12];

	new_face_1[0] = NODES[12];
	new_face_1[1] = NODES[17];
	new_face_1[2] = NODES[15];
	new_face_1[3] = NODES[10];

	new_face_2[0] = NODES[11];
	new_face_2[1] = NODES[12];
	new_face_2[2] = NODES[17];
	new_face_2[3] = NODES[16];

	new_face_3[0] = NODES[12];
	new_face_3[1] = NODES[9];
	new_face_3[2] = NODES[14];
	new_face_3[3] = NODES[17];
...
void cut_cell_yz(E_Int cell, mesh *M, tree *ct, tree *ft)
{
	...
	new_face_0[0] = NODES[13];
	new_face_0[1] = NODES[8];
	new_face_0[2] = NODES[12];
	new_face_0[3] = NODES[17];

	new_face_1[0] = NODES[17];
	new_face_1[1] = NODES[12];
	new_face_1[2] = NODES[10];
	new_face_1[3] = NODES[15];

	new_face_2[0] = NODES[11];
	new_face_2[1] = NODES[16];
	new_face_2[2] = NODES[17];
	new_face_2[3] = NODES[12];

	new_face_3[0] = NODES[12];
	new_face_3[1] = NODES[17];
	new_face_3[2] = NODES[14];
	new_face_3[3] = NODES[9];
...
void cut_cell_xyz(E_Int cell, mesh *M, tree *ct, tree *ft)
{
	...
	new_face_0[0] = NODES[8];  new_face_1[0] = NODES[12]; new_face_2[0] = NODES[15];
	new_face_0[1] = NODES[12]; new_face_1[1] = NODES[10]; new_face_2[1] = NODES[22];
	new_face_0[2] = NODES[26]; new_face_1[2] = NODES[25]; new_face_2[2] = NODES[26];
	new_face_0[3] = NODES[22]; new_face_1[3] = NODES[26]; new_face_2[3] = NODES[16];

	new_face_3[0] = NODES[22]; new_face_4[0] = NODES[16]; new_face_5[0] = NODES[26];
	new_face_3[1] = NODES[19]; new_face_4[1] = NODES[26]; new_face_5[1] = NODES[20];
	new_face_3[2] = NODES[20]; new_face_4[2] = NODES[25]; new_face_5[2] = NODES[17];
	new_face_3[3] = NODES[26]; new_face_4[3] = NODES[13]; new_face_5[3] = NODES[25];

	new_face_6[0] = NODES[12]; new_face_7[0] = NODES[9];  new_face_8[0] = NODES[22];
	new_face_6[1] = NODES[11]; new_face_7[1] = NODES[12]; new_face_8[1] = NODES[26];
	new_face_6[2] = NODES[16]; new_face_7[2] = NODES[26]; new_face_8[2] = NODES[24];
	new_face_6[3] = NODES[26]; new_face_7[3] = NODES[20]; new_face_8[3] = NODES[21];

	new_face_9[0] = NODES[26]; new_face_10[0] = NODES[26]; new_face_11[0] = NODES[20];
	new_face_9[1] = NODES[25]; new_face_10[1] = NODES[16]; new_face_11[1] = NODES[26];
	new_face_9[2] = NODES[23]; new_face_10[2] = NODES[14]; new_face_11[2] = NODES[24];
	new_face_9[3] = NODES[24]; new_face_10[3] = NODES[24]; new_face_11[3] = NODES[18];
	...
	M->owner[nfaces+2] = ncells;
	M->neigh[nfaces+2] = ncells+4;

	M->owner[nfaces+3] = ncells+1;
	M->neigh[nfaces+3] = ncells+5;

	M->owner[nfaces+4] = ncells+2;
	M->neigh[nfaces+4] = ncells+6;

	M->owner[nfaces+5] = ncells+3;
	M->neigh[nfaces+5] = ncells+7;

	M->owner[nfaces+6] = ncells;
	M->neigh[nfaces+6] = ncells+2;

	M->owner[nfaces+7] = ncells+1;
	M->neigh[nfaces+7] = ncells+3;

	M->owner[nfaces+8] = ncells+4;
	M->neigh[nfaces+8] = ncells+5;

	M->owner[nfaces+9] = ncells+6;
	M->neigh[nfaces+9] = ncells+7;

	M->owner[nfaces+10] = ncells+4;
	M->neigh[nfaces+10] = ncells+6;

	M->owner[nfaces+11] = ncells+5;
	M->neigh[nfaces+11] = ncells+7;
