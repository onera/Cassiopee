...
*/
//=============================================================================
E_Int K_LOC::center2nodeStruct2(FldArrayF& FCenter, 
        ...
        else
        {
          ...
          #pragma omp parallel
          {
            ...
            for (E_Int ind = 0; ind < im1*jm1*km1; ind++)
            {
              ...
              {
                w2 = max(cellN0,1.)+max(cellN1,1.)+max(cellN2,1.)+max(cellN3,1.)+max(cellN4,1.)+max(cellN5,1.)+max(cellN6,1.)+max(cellN7,1.);
                if (w2 > 8.5)
                  cellNpn[ind] = 2.;
                else
                  cellNpn[ind] = 1.;
...
//=============================================================================
E_Int K_LOC::center2nodeUnstruct2(FldArrayF& FCenter, 
                                 FldArrayI& c,
                                 E_Int cellN, E_Int mod,
                                 E_Int posx, E_Int posy, E_Int posz,
                                 FldArrayF& FNode,
