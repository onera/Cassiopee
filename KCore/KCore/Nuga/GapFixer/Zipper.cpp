 ...
 const K_FLD::IntArray& connectE2, K_FLD::IntArray& bottomE2)
{
  ...
  K_CONNECT::MeshTool::getAttachedElements(connectE2, connectT3, connectAT3);
  K_CONNECT::EltAlgo<K_MESH::Triangle>::getManifoldNeighbours(connectAT3, neighbors);
 ...
 const std::vector<E_Int>& realID, std::vector<E_Float>& R2)
{
  ...
  K_FLD::FloatArray L2;
  K_CONNECT::MeshTool::computeEdgesSqrLengths<3>(vpos, vE2, L2);
