...
tc = C.node2Center(t)
t, tc, front, front2 = XIBM.buildFrontIBM(t, tc, dimPb=3, frontType=42, interpDataType=1, check=True)
XIBM._setInterpDataIBM(t, tc, tb, front, frontType=42, interpDataType=1, dimPb=3)
