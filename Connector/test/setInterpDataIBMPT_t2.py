...
tc = C.node2Center(t)
t, tc, front, front2 = XIBM.buildFrontIBM(t, tc, dimPb=3, interpDataType=1)
XIBM._setInterpDataIBM(t, tc, tb, front, dimPb=3, frontType=1, interpDataType=1)
test.testT(t, 1)
test.testT(tc, 11)
...
tc = C.node2Center(t)
t, tc, front, front2 = XIBM.buildFrontIBM(t, tc, dimPb=3, frontType=42, interpDataType=1)
XIBM._setInterpDataIBM(t, tc, tb, front, dimPb=3, frontType=42, interpDataType=1)
test.testT(t, 2)
test.testT(tc, 21)
...
tc = C.node2Center(t)
t, tc, front, front2 = XIBM.buildFrontIBM(t, tc, dimPb=3, frontType=42, interpDataType=1,twoFronts=True)
XIBM._setInterpDataIBM(t, tc, tb, front, front2=front2, dimPb=3, frontType=42, twoFronts=True, interpDataType=1)
test.testT(t, 5)
test.testT(tc, 51)
