...
.. py:function:: Connector.setDoublyDefinedBC(a, cellN, tol=1.e-10)
    ...
    <em> WARNING: currently, no periodic Chimera taken into account by this function automatically.</em>
    ...
    <div class="code"> a = X.setInterpData(aR, aD, double_wall=0, order=2, penalty=1, nature=0, loc='nodes', storage='direct', topTreeRcv=None, topTreeDnr=None, sameName=0) </div>
    ...
    <strong>X.extractChimeraInfo</strong>:
    ...
    <div class="code"> t = X.extractChimeraInfo(t, type='interpolated',loc='centers')</div>
    <em> Example of use: </em> <a href="Examples/Connector/extractChimeraInfoPT.py"> Extract Chimera points (pyTree).</a><br><br>
