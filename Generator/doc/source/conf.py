# -*- coding: utf-8 -*-
#
# Generator documentation build configuration file
...
htmlhelp_basename = 'Generatordoc'
...
man_pages = [
    ('index', 'generator', u'Generator Documentation',
     [u'ONERA'], 1)
]
...
texinfo_documents = [
  ('index', 'Generator', u'Generator Documentation',
   u'ONERA', 'Generator', 'One line description of project.',
   'Miscellaneous'),
]
