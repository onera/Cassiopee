...
.. py:function:: Generator.tetraMesher(a, algo=1) 
...
.. py:function:: Generator.octree(surfs, snears, dfar=5., balancing=0, levelMax=1000, ratio=2, octant=None)
    ...
    :type  ratio:  integer
    .. :param octant: starting octant (optional and used instead of dfar)
    .. :type octant: list of floats [xmin,ymin,zmin,xmax,ymax,zmax]
