...
public:
  static E_Int import_cad(const char* fname, const char*format, std::vector<K_FLD::FloatArray> & crds, std::vector<K_FLD::IntArray>& connectMs, E_Float h=0., E_Float chordal_err=0.);
private:
