...
namespace K_NUMPY
{
  ...
  E_Int getFromNumpyArray(PyObject* o, FldArrayI*& f, E_Boolean shared=true);
  E_Int getFromNumpyArray(PyObject* o, FldArrayF*& f, E_Boolean shared=true);
  E_Int getFromNumpyArray(PyObject* o, E_Int*& f, E_Int& size, E_Int& nfld, E_Boolean shared=true);
  E_Int getFromNumpyArray(PyObject* o, E_Int*& f, E_Int& size, E_Boolean shared=true);
  E_Int getFromNumpyArray(PyObject* o, E_Float*& f, E_Int& size, E_Int& nfld, E_Boolean shared=true);
  E_Int getFromNumpyArray(PyObject* o, E_Float*& f, E_Int& size, E_Boolean shared=true);

  // identical to getFromNumpy but return a flat array in case of (1,nb) arrays
  E_Int getFromPointList(PyObject* o, FldArrayI*& f, E_Boolean shared=true);
  E_Int getFromPointList(PyObject* o, E_Int*& f, E_Int& size, E_Int& nfld, E_Boolean shared=true);
