...
// #endif
    for (E_Int noind = pt_deb; noind < pt_fin; noind++)
    {
      ...
      val0  = ptrCoefs[ indCoef     ]*vectOfmacroDnrFields[0][ind000];
      val0 += ptrCoefs[ indCoef + 1 ]*vectOfmacroDnrFields[0][ind100];
      val0 += ptrCoefs[ indCoef + 2 ]*vectOfmacroDnrFields[0][ind010];
      val0 += ptrCoefs[ indCoef + 3 ]*vectOfmacroDnrFields[0][ind110];
      val0 += ptrCoefs[ indCoef + 4 ]*vectOfmacroDnrFields[0][ind001];
      val0 += ptrCoefs[ indCoef + 5 ]*vectOfmacroDnrFields[0][ind101];
      val0 += ptrCoefs[ indCoef + 6 ]*vectOfmacroDnrFields[0][ind011];
      val0 += ptrCoefs[ indCoef + 7 ]*vectOfmacroDnrFields[0][ind111];

      val1  = ptrCoefs[ indCoef     ]*vectOfmacroDnrFields[1][ind000];
      val1 += ptrCoefs[ indCoef + 1 ]*vectOfmacroDnrFields[1][ind100];
      val1 += ptrCoefs[ indCoef + 2 ]*vectOfmacroDnrFields[1][ind010];
      val1 += ptrCoefs[ indCoef + 3 ]*vectOfmacroDnrFields[1][ind110];
      val1 += ptrCoefs[ indCoef + 4 ]*vectOfmacroDnrFields[1][ind001];
      val1 += ptrCoefs[ indCoef + 5 ]*vectOfmacroDnrFields[1][ind101];
      val1 += ptrCoefs[ indCoef + 6 ]*vectOfmacroDnrFields[1][ind011];
      val1 += ptrCoefs[ indCoef + 7 ]*vectOfmacroDnrFields[1][ind111];

      val2  = ptrCoefs[ indCoef     ]*vectOfmacroDnrFields[2][ind000];
      val2 += ptrCoefs[ indCoef + 1 ]*vectOfmacroDnrFields[2][ind100];
      val2 += ptrCoefs[ indCoef + 2 ]*vectOfmacroDnrFields[2][ind010];
      val2 += ptrCoefs[ indCoef + 3 ]*vectOfmacroDnrFields[2][ind110];
      val2 += ptrCoefs[ indCoef + 4 ]*vectOfmacroDnrFields[2][ind001];
      val2 += ptrCoefs[ indCoef + 5 ]*vectOfmacroDnrFields[2][ind101];
      val2 += ptrCoefs[ indCoef + 6 ]*vectOfmacroDnrFields[2][ind011];
      val2 += ptrCoefs[ indCoef + 7 ]*vectOfmacroDnrFields[2][ind111];

      val3  = ptrCoefs[ indCoef     ]*vectOfmacroDnrFields[3][ind000];
      val3 += ptrCoefs[ indCoef + 1 ]*vectOfmacroDnrFields[3][ind100];
      val3 += ptrCoefs[ indCoef + 2 ]*vectOfmacroDnrFields[3][ind010];
      val3 += ptrCoefs[ indCoef + 3 ]*vectOfmacroDnrFields[3][ind110];
      val3 += ptrCoefs[ indCoef + 4 ]*vectOfmacroDnrFields[3][ind001];
      val3 += ptrCoefs[ indCoef + 5 ]*vectOfmacroDnrFields[3][ind101];
      val3 += ptrCoefs[ indCoef + 6 ]*vectOfmacroDnrFields[3][ind011];
      val3 += ptrCoefs[ indCoef + 7 ]*vectOfmacroDnrFields[3][ind111];

      val4  = ptrCoefs[ indCoef     ]*vectOfmacroDnrFields[4][ind000];
      val4 += ptrCoefs[ indCoef + 1 ]*vectOfmacroDnrFields[4][ind100];
      val4 += ptrCoefs[ indCoef + 2 ]*vectOfmacroDnrFields[4][ind010];
      val4 += ptrCoefs[ indCoef + 3 ]*vectOfmacroDnrFields[4][ind110];
      val4 += ptrCoefs[ indCoef + 4 ]*vectOfmacroDnrFields[4][ind001];
      val4 += ptrCoefs[ indCoef + 5 ]*vectOfmacroDnrFields[4][ind101];
      val4 += ptrCoefs[ indCoef + 6 ]*vectOfmacroDnrFields[4][ind011];
      val4 += ptrCoefs[ indCoef + 7 ]*vectOfmacroDnrFields[4][ind111];
