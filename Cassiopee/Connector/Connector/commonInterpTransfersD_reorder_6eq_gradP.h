...
switch (type)
{
  case 0:  //  nuage de pts quelconque
    for (E_Int noind = pt_deb; noind < pt_fin; noind++)
    {
      ...
      vectOfGradRcvFields[0][noind] = val0;
      vectOfGradRcvFields[1][noind] = val1;
      vectOfGradRcvFields[2][noind] = val2;
      vectOfGradRcvFields[3][noind] = val3;
      vectOfGradRcvFields[4][noind] = val4;
      vectOfGradRcvFields[5][noind] = val5;
      sizecoefs = ncfLoc;
      noi += ncfLoc+1;
      indCoef += sizecoefs;
    }
  ...
  case 1:
    for (E_Int noind = pt_deb; noind < pt_fin; noind++)
    {
      ...
      vectOfGradRcvFields[0][noind] = vectOfGradDnrFields[0][indD0];
      vectOfGradRcvFields[1][noind] = vectOfGradDnrFields[1][indD0];
      vectOfGradRcvFields[2][noind] = vectOfGradDnrFields[2][indD0];
      vectOfGradRcvFields[3][noind] = vectOfGradDnrFields[3][indD0];
      vectOfGradRcvFields[4][noind] = vectOfGradDnrFields[4][indD0];
      vectOfGradRcvFields[5][noind] = vectOfGradDnrFields[5][indD0];
    }
    break;
