...
switch (type)
{
  case 0:  //  nuage de pts quelconque
    for (E_Int noind = pt_deb; noind < pt_fin; noind++)
    {
      ...
      vectOfRcvFields[5][indR] = val5;
      vectOfRcvFields[6][indR] = val6;
      vectOfRcvFields[7][indR] = val7;
      vectOfRcvFields[8][indR] = val8;
      vectOfRcvFields[9][indR] = val9;
      vectOfRcvFields[10][indR]= val10;
      vectOfRcvFields[11][indR]= val11;
      vectOfRcvFields[12][indR]= val12;
      vectOfRcvFields[13][indR]= val13;
      vectOfRcvFields[14][indR]= val14;
      vectOfRcvFields[15][indR]= val15;
      vectOfRcvFields[16][indR]= val16;
      vectOfRcvFields[17][indR]= val17;
      vectOfRcvFields[18][indR]= val18;
      sizecoefs = ncfLoc;
      noi      += ncfLoc+1;
      indCoef  += sizecoefs;
    }
  ...
  case 1:
    for (E_Int noind = pt_deb; noind < pt_fin; noind++)
    {
      ...
      vectOfRcvFields[5][indR] = vectOfDnrFields[5][indD0];
      vectOfRcvFields[6][indR] = vectOfDnrFields[6][indD0];
      vectOfRcvFields[7][indR] = vectOfDnrFields[7][indD0];
      vectOfRcvFields[8][indR] = vectOfDnrFields[8][indD0];
      vectOfRcvFields[9][indR] = vectOfDnrFields[9][indD0];
      vectOfRcvFields[10][indR]= vectOfDnrFields[10][indD0];
      vectOfRcvFields[11][indR]= vectOfDnrFields[11][indD0];
      vectOfRcvFields[12][indR]= vectOfDnrFields[12][indD0];
      vectOfRcvFields[13][indR]= vectOfDnrFields[13][indD0];
      vectOfRcvFields[14][indR]= vectOfDnrFields[14][indD0];
      vectOfRcvFields[15][indR]= vectOfDnrFields[15][indD0];
      vectOfRcvFields[16][indR]= vectOfDnrFields[16][indD0];
      vectOfRcvFields[17][indR]= vectOfDnrFields[17][indD0];
      vectOfRcvFields[18][indR]= vectOfDnrFields[18][indD0];
    }
    break;
      ...
      for (E_Int kk=0; kk<4; kk++)
        for (E_Int jj=0; jj<4; jj++)
          for (E_Int ii=0; ii<4; ii++)
          {
            ...
            val10 += ptrCoefs[ indCoef + ii]*ptrCoefs[ indCoef + jj+4]*ptrCoefs[ indCoef + kk+8]*vectOfDnrFields[0][indD];               
