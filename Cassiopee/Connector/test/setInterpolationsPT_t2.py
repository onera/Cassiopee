...
t1 = X.setInterpolations(t1, loc='cell',storage='inverse')
test.testT(t1,1)
# depth = 1
t2 = X.applyBCOverlaps(t, depth=1)
t2 = X.setInterpolations(t2, loc='face',storage='inverse')
t2 = X.setInterpolations(t2, loc='cell',storage='inverse')
test.testT(t2,2)
