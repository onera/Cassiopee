...
t,tc=X_IBM.prepareIBMData_legacy(t,tb, DEPTH=2,frontType=0, interpDataType=1)
...
DTW._distance2Walls(t,bodies=tb,loc='centers',type='ortho')
C._initVars(t,'centers:cellN',1.)
t,tc=X_IBM.prepareIBMData_legacy(t,tb, DEPTH=2,frontType=1, interpDataType=1)
test.testT(tc,12)
...
C._addState(tb, 'GoverningEquations', 'NSTurbulent')
DTW._distance2Walls(t,bodies=tb,loc='centers',type='ortho')
t,tc=X_IBM.prepareIBMData_legacy(t,tb, DEPTH=2,frontType=2)
test.testT(tc,13)
...
C._initVars(t,'centers:cellN',1.)
t,tc=X_IBM.prepareIBMData_legacy(t,tb,DEPTH=2,frontType=2, interpDataType=1)
test.testT(tc,23)
