...
XIBM._setInterpDataIBM(t, tc, tb, front=front, dimPb=2, frontType=1, cartesian=False)
####
...
XIBM._setInterpDataIBM(t, tc, tb, front=front, dimPb=2, frontType=42, cartesian=False)
####
# The following lines are to avoid regression since the bug fix for duplicate information in tc
####
Internal._rmNodesByName(tc, '.Solver#Param')
...
XIBM._setInterpDataIBM(t, tc, tb, front=front, front2=front2, dimPb=2, frontType=42, twoFronts=True, cartesian=False)
####
# The following lines are to avoid regression since the bug fix for duplicate information in tc
####
Internal._rmNodesByName(tc, '.Solver#Param')
