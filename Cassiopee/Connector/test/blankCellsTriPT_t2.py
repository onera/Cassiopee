...
# Blanking
t = X.blankCellsTri(t, [[m]], [], blankingType="node_in", tol=1.e-12, cellnval=4, overwrite=1)
...
# Blanking
t = X.blankCellsTri(t, [[m]], [], blankingType="center_in", tol=1.e-12, cellnval=4, overwrite=1)
...
#C.convertPyTree2File(t, 'b.plt')
# Blanking
t = X.blankCellsTri(t, [[m]], [], blankingType="cell_intersect", tol=1.e-12, cellnval=4, overwrite=1)
