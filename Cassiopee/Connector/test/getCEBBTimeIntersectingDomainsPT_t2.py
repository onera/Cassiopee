...
a = G.cylinder((0.,0.,0.), 0.5, 1., 360., 0., 0., (50,50,3))
# --- CL
...
b = G.cylinder((1.5,0.,0.), 0.5, 1., 360., 0., 0., (50,50,3))
# --- champ aux centres
# --- CL
...
#
dt = 1.; Funcs = [F,[]]
b1 = G.cart((-2.,-2.,0.),(0.4,0.4,1),(11,11,1))
b2 = G.cart((-4.,-2.,0.),(0.4,0.4,1),(11,11,1))
b3 = G.cart((2.,-2.,0.),(0.4,0.4,1),(11,11,1))
#
t = C.addBase2PyTree(t,'Cart');t[2][2][2] = [b1,b2,b3]
