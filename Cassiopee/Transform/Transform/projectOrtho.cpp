...
// ============================================================================
/* Projete une surface array1 sur une surface array2 (TRI) */
// ============================================================================
PyObject* K_TRANSFORM::projectOrtho(PyObject* self, PyObject* args)
{
  ...
  if (isOk == -1)
  {
    PyErr_SetString(PyExc_TypeError,
                    "projectOrtho: invalid list of arrays.");
  ...
  if (res2 != 2)
  {
    ...
    PyErr_SetString(PyExc_TypeError,
                    "projectOrtho: array2 must be unstructured.");
    return NULL;
  }
  if (strcmp(eltType2, "TRI") != 0 && strcmp(eltType2, "BAR") != 0)
  {
    ...
    PyErr_SetString(PyExc_TypeError,
                    "projectOrtho: array2 must be a TRI or BAR array.");
    return NULL;
  }
  ...
  if (posx2 == -1 || posy2 == -1 || posz2 == -1)
  {
    ...
    RELEASESHAREDU(array2, f2, cn2);
    PyErr_SetString(PyExc_TypeError,
                    "projectOrtho: coordinates not found in array2.");
    return NULL;
  }
  posx2++; posy2++; posz2++;
  ...
  for (E_Int nou = 0; nou < nu; nou++)
  {
    ...
    PyObject* tpl = K_ARRAY::buildArray(nfld, unstrVarString[nou], npts, nelts,
                                        -1, eltType[nou], false, nelts);
    E_Float* fp = K_ARRAY::getFieldPtr(tpl);
