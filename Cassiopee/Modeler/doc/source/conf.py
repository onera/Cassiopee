# -*- coding: utf-8 -*-
#
# Modeler documentation build configuration file
...
try:
    ...
    with open('../../Modeler/Modeler.py') as f:
        for line in f:
...
latex_documents = [
    ('Modeler', 'Modeler.tex', u'Modeler Documentation',
