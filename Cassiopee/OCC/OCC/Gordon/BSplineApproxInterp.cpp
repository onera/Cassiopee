 ...
 */
BSplineApproxInterp::BSplineApproxInterp(const TColgp_Array1OfPnt& points, int nControlPoints, int degree, bool continuous_if_closed)
...
void BSplineApproxInterp::InterpolatePoint(size_t pointIndex, bool withKink)
{
...
bool BSplineApproxInterp::isClosed() const
{
    if (!m_C2Continuous) {
        return false;
    }
...
bool BSplineApproxInterp::firstAndLastInterpolated() const
{
