...
/* Functions declarations */
 ...
 extern void   MMG5_bezierEdge(MMG5_pMesh, MMG5_int, MMG5_int, double [3], double [3], int8_t, double [3]);
 int           MMG5_buildridmet(MMG5_pMesh,MMG5_pSol,MMG5_int,double,double,double,double*,double[3][3]);
 extern int    MMG5_buildridmetfic(MMG5_pMesh,double[3],double[3],double,double,double,double[6]);
 int           MMG5_buildridmetnor(MMG5_pMesh, MMG5_pSol, MMG5_int,double[3], double[6],double[3][3]);
 ...
 int           MMG5_intridmet(MMG5_pMesh,MMG5_pSol,MMG5_int,MMG5_int,double,double[3],double[6]);
 ...
 int           MMG5_mmgIntextmet(MMG5_pMesh,MMG5_pSol,MMG5_int,double [6],double [3]);
 ...
 int           MMG5_solveDefmetregSys( MMG5_pMesh, double r[3][3], double [3], double [6],
                                        double [3], double *, double, double, double);
 int           MMG5_solveDefmetrefSys( MMG5_pMesh,MMG5_pPoint,MMG5_int[2], double r[3][3],
                                        double [3], double [6], double [3], double *,
                                        double, double, double);
 double        MMG5_surftri_ani(MMG5_pMesh mesh,MMG5_pSol met,MMG5_pTria ptt);
 double        MMG5_surftri33_ani(MMG5_pMesh,MMG5_pTria,double[6],double[6],double[6]);
 ...
 int           MMG5_interpreg_ani(MMG5_pMesh,MMG5_pSol,MMG5_pTria,int8_t,double,double[6]);
