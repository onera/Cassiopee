...
PyObject* K_XCORE::chunk2partNGon(PyObject *self, PyObject *args)
{
  ...
  if (rank == 0) printf("ParentElements OK\n");
  ...
  if (rank == 0) puts("Comm patches OK");
  ...
  for (E_Int i = 0; i < nncells; i++) pc[i] = rcells[i];
