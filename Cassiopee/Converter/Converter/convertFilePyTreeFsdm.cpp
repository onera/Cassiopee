...
// Convert file H5 FSDM / pyTree CGNS
...
// ============================================================================
PyObject* K_CONVERTER::convertFile2PyTreeFsdm(PyObject* self, PyObject* args)
{
  ...
  E_Int ret = K_IO::GenIO::getInstance()->hdffsdmread(fileName, tree);
  printf("done.\n");
...
// ============================================================================
PyObject* K_CONVERTER::convertPyTree2FileFsdm(PyObject* self, PyObject* args)
{
  ...
  K_IO::GenIO::getInstance()->hdffsdmwrite(fileName, t);
  printf("done.\n");
