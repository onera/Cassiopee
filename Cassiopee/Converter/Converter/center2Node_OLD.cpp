...
// ============================================================================
PyObject* K_CONVERTER::center2Node_OLD(PyObject* self, PyObject* args)
{
  PyObject* array;
  E_Int type;
  ...
  if (res == 1)
  {
    ...
    ret = K_LOC::center2nodeStruct_OLD(*FCenter, ni, nj, nk, cellN, mod, 
  ...
  else if (res == 2)
  {
        ...
        K_STRING::cmp(eltType, "NGON*") == 0)
    {
      ...
      */
      ...
      ret = K_LOC::center2nodeNGon_OLD(*FCenter, *c, cEV, *FNode, cellN, mod, type);
    ...
    {    
               ...
               K_STRING::cmp(eltType, "PYRA*") == 0 ) 
      {
        ...
        FNode = new FldArrayF(nb, nfld);      
        ret = K_LOC::center2nodeUnstruct_OLD(*FCenter, *c, cellN, mod, posx, posy, posz, *FNode, type);
      }
      else // autres
      {
        PyErr_SetString(PyExc_TypeError, 
