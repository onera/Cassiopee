...
PyObject* K_CONVERTER::convertArray2Tetra(PyObject* self, PyObject* args)
{
  ...
  char* varString; char* eltType; char* eltType2;
  ...
  if (res == 1)
  {
    PyObject* tpl = convertStruct2Tetra(varString, f, nil, njl, nkl);
  ...
  E_Int dim0 = -1;
  if (K_STRING::cmp(eltType, "HEXA") != 0 && K_STRING::cmp(eltType, "QUAD") != 0)
  {
