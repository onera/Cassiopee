...
# set(INT_LIB "mkl_intel_il64")
set(INT_LIB           "mkl_intel_lp64"   )
set(BLAS95_LIB_NAME   "mkl_blas95_lp64"  )
set(LAPACK95_LIB_NAME "mkl_lapack95_lp64")
...
find_path(MKL_MODULE_PATH NAMES blas95.mod HINTS $ENV{MKLROOT}/include/intel64/lp64)
...
find_library(MKL_BLAS95_LIBRARY
             NAMES ${BLAS95_LIB_NAME}
             PATHS $ENV{MKLROOT}/lib
                   $ENV{MKLROOT}/lib/intel64
                   $ENV{INTEL}/mkl/lib/intel64
             NO_DEFAULT_PATH)

find_library(MKL_LAPACK95_LIBRARY
             NAMES ${LAPACK95_LIB_NAME}
             PATHS $ENV{MKLROOT}/lib
                   $ENV{MKLROOT}/lib/intel64
                   $ENV{INTEL}/mkl/lib/intel64
             NO_DEFAULT_PATH)
...
# message(${MKL_MODULE_PATH})
# message(${MKL_LAPACK95_LIBRARY})
# message(${MKL_BLAS95_LIBRARY})

# set(CMAKE_Fortran_MODULE_DIRECTORY " ${CMAKE_Fortran_MODULE_DIRECTORY} ${MKL_MODULE_PATH} ")

# message( "MKL_INTERFACE_LIBRARY : " ${MKL_INTERFACE_LIBRARY})
set(MKL_INCLUDE_DIRS ${MKL_INCLUDE_DIR})
# set(MKL_MODULE_PATH ${MKL_MODULE_PATH_TMP})
set(MKL_LIBRARIES ${MKL_INTERFACE_LIBRARY} ${MKL_SEQUENTIAL_LAYER_LIBRARY}
                  ${MKL_CORE_LIBRARY} ${BLAS95_LIB_NAME} ${MKL_LAPACK95_LIBRARY})
...
if (MKL_INCLUDE_DIR AND
    ...
    set(CMAKE_Fortran_FLAGS "${CMAKE_Fortran_FLAGS} -DMKL_LP64 ${ABI}")
