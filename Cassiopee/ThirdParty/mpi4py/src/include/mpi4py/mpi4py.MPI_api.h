...
static PyObject *(*__pyx_f_6mpi4py_3MPI_PyMPIMessage_New)(MPI_Message) = 0;
#define PyMPIMessage_New __pyx_f_6mpi4py_3MPI_PyMPIMessage_New
static MPI_Message *(*__pyx_f_6mpi4py_3MPI_PyMPIMessage_Get)(PyObject *) = 0;
#define PyMPIMessage_Get __pyx_f_6mpi4py_3MPI_PyMPIMessage_Get
...
static int import_mpi4py__MPI(void) {
  ...
  if (__Pyx_ImportFunction(module, "PyMPIMessage_New", (void (**)(void))&__pyx_f_6mpi4py_3MPI_PyMPIMessage_New, "PyObject *(MPI_Message)") < 0) goto bad;
  if (__Pyx_ImportFunction(module, "PyMPIMessage_Get", (void (**)(void))&__pyx_f_6mpi4py_3MPI_PyMPIMessage_Get, "MPI_Message *(PyObject *)") < 0) goto bad;
  ...
  __pyx_ptype_6mpi4py_3MPI_Topocomm = __Pyx_ImportType("mpi4py.MPI", "Topocomm", sizeof(struct PyMPITopocommObject), 1); if (!__pyx_ptype_6mpi4py_3MPI_Topocomm) goto bad;
  ...
  __pyx_ptype_6mpi4py_3MPI_Message = __Pyx_ImportType("mpi4py.MPI", "Message", sizeof(struct PyMPIMessageObject), 1); if (!__pyx_ptype_6mpi4py_3MPI_Message) goto bad;
