...
namespace
{
  inline E_Float X(E_Float x)
  {
    return (50. + x) / 10;
  }

  inline E_Float Y(E_Float y)
  {
    return (50. - y) / 10;
  }
}  // namespace
...
namespace SVG
{
  ...
  void
  write_circle_svg(FILE* fich, const point& p, E_Float r, int thick, const std::string& color_border)
  {
  ...
  void
  write_circle_svg(FILE* fich, const point& p, E_Float r, const std::string& fill_color, E_Float fill_opacity)
  {
    fprintf(fich,
