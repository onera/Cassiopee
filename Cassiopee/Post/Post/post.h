...
// ************************************************************************** //
  ...
  PyObject* exteriorFacesBasic(char* varString, FldArrayF& f,
                               ...
                               PyObject* Indices);
  PyObject* selectExteriorFacesME_NOMP(char* varString, FldArrayF& f,
                                       FldArrayI& cn, char* eltType);
  ...
  PyObject* selectExteriorEltsBasic3(FldArrayF& f, FldArrayI& cn,
                                     char* eltType, char* varString,
                                     E_Int posx, E_Int posy, E_Int posz);
  PyObject* selectExteriorEltsME_NOMP(FldArrayF& f, FldArrayI& cn, 
                                      char* eltType, char* varString);
  PyObject* selectExteriorEltsME2_NOMP(FldArrayF& f, FldArrayI& cn, 
                                       char* eltType, char* varString);
