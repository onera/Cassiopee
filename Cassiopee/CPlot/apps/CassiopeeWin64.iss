...
[Files]
Source: "C:\Users\benoit\Code\Cassiopee\Dist\*"; DestDir: "{app}\Dist" ; Flags: recursesubdirs createallsubdirs
...
begin
  ...
  lines[1] := 'path=%CASSIOPEE%\Dist\bin\win64\lib;%CASSIOPEE%\Dist\bin\win64\bin2;%CASSIOPEE%\Dist\bin\win64;%PATH%';
  lines[2] := 'set PYTHONEXE=python3.12';
  lines[3] := 'set PYTHONHOME=%CASSIOPEE%\Dist\bin\win64\bin2';
  lines[4] := 'set ELSAPROD=win64';
  lines[5] := 'set PYTHONPATH=%CASSIOPEE%\Dist\bin\win64\bin2;%CASSIOPEE%\Dist\bin\win64\lib\python3.12;%CASSIOPEE%\Dist\bin\win64\lib\python3.12\site-packages';
  ...
  lines[1] := '$Env:Path = "$CASSIOPEE\Dist\bin\win64\lib;$CASSIOPEE\Dist\bin\win64\lib2;$CASSIOPEE\Dist\bin\win64\bin2;$CASSIOPEE\Dist\bin\win64;$Env:Path"';
  lines[2] := '$global:PYTHONEXE = "python3.12"';
  lines[3] := '$global:PYTHONHOME = "$CASSIOPEE\Dist\bin\win64"';
  lines[4] := '$global:ELSAPROD = "win64"';
  lines[5] := '$global:PYTHONPATH = "$CASSIOPEE\Dist\bin\win64\bin2;$CASSIOPEE\Dist\bin\win64\lib2\python3.12;$CASSIOPEE\Dist\bin\win64\lib2\python3.12\site-packages;$CASSIOPEE\Dist\bin\win64\lib\python3.12\site-packages"';
  ...
  lines[4] := 'set ELSAPROD=win64';
  lines[5] := 'set PYTHONPATH=%CASSIOPEE%\Dist\bin\win64;%CASSIOPEE%\Dist\bin\win64\Lib\python3.12;%CASSIOPEE%\Dist\bin\win64\lib\python3.12\site-packages'
