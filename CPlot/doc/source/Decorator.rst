...
.. py:function:: CPlot.Decorator.createSubPlot(title=None)
...
.. py:function:: CPlot.Decorator.createColorBar(fig, ax, levels=None, title=None, cmap=None, valueFormat='%0.3f', discrete=True)
...
.. py:function:: CPlot.Decorator.createText(ax, posx=0, posy=0, text='', size=20, box=False)
    
    Create a text on figure.

    :param posx: position of text in axis
    :type posx: float
    :param posy: position of text in axis
    :type posy: float
