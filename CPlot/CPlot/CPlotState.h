...
struct CPlotState {
    ...
    double colormapR1, colormapG1, colormapB1; // starting color for bicolor colormaps
    double colormapR2, colormapG2, colormapB2; // starting color for bicolor colormaps   
