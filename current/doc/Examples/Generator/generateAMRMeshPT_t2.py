...
t = G_AMR.generateAMRMesh(tb, levelMax=1, vmins=[[5,5]], dim=dimPb, check=False, localDir=LOCAL)
test.testT(t,1)
...
t = G_AMR.generateAMRMesh(tb, levelMax=1, toffset=toffset, vmins=[[5]], dim=dimPb, check=False, localDir=LOCAL)
test.testT(t,2)
